...
def test_load_dataset():
    ...
    CWD = os.getcwd()
    path_to_train = os.path.join(CWD, 'packages/datacube_bigmart/datacube_bigmart/datasets/Train.csv')
    path_to_test = os.path.join(CWD, 'packages/datacube_bigmart/datacube_bigmart/datasets/Test.csv')
